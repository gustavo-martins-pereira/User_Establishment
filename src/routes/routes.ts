...
import { createEstablishment, deleteEstablishmentById, getAllEstablishments, getEstablishmentById, updateEstablishmentById } from "@controllers/establishmentController.ts";
import { deleteEstablishmentByIdValidator, getEstablishmentByIdValidator, postCreateEstablishmentValidator, putUpdateEstablishmentValidator } from "./validators/establishmentValidators.ts";
